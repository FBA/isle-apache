...
ENV PATH=$PATH:$HOME/.composer/vendor/bin \
    ...
    IMAGEMAGICK_VERSION=${IMAGEMAGICK_VERSION:-7.1.0-10} \
...
ENV COMPOSER_HASH=${COMPOSER_HASH:-fb3b7bc001353e623026df45241fd69e819856e6} \
    COMPOSER_VERSION=${COMPOSER_VERSION:-1.10.23} \
